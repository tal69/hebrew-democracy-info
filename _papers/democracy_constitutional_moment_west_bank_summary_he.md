---
{
  ...
  "oneLinerHtml": "שורה תחתונה: המאמר טוען שאי אפשר להבין את הרגע החוקתי בישראל בלי להתייחס גם לשאלת השליטה בגדה המערבית ולמי נכלל בתוך הקהילה הפוליטית שמעצבת את החוקה.",
  "sections": [
    {
